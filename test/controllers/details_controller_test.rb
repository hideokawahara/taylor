...
class DetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post details_url, params: { detail: { record_tag_id: @detail.record_tag_id, title: @detail.title, user_id: @detail.user_id, year: @detail.year } }, as: :json
    end
  ...
  test "should update detail" do
    patch detail_url(@detail), params: { detail: { record_tag_id: @detail.record_tag_id, title: @detail.title, user_id: @detail.user_id, year: @detail.year } }, as: :json
    assert_response 200
  end
